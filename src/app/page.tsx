  ...
  return (
    <div className="max-w-7xl m-auto px-4 mt-[100] flex flex-col items-center text-center">
      ...
      <div className="grid md:grid-cols-2 gap-6 w-full max-w-3xl">
        ...
        <Link
          href="/BTUCalculator"
          className="group bg-primary text-surface rounded-2xl p-8 text-left
                     border-2 border-transparent hover:border-surface
                     transition-all hover:-translate-y-1"
        >
          <div className="w-12 h-12 rounded-xl bg-surface/20 flex items-center justify-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-surface" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <p className="text-sm text-surface/80 mb-4">
